...
import { Loader2, ExternalLink, AlertTriangle, RefreshCw, Download, FileText } from 'lucide-react';

export function FallbackActions({ handleRetry, openUrl, downloadUrl }) {
  return (
